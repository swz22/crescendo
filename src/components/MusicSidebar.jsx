  ...
  return (
    <div
      className={`w-full flex flex-row items-center hover:bg-gradient-to-r hover:from-white/5 hover:to-transparent ${
        isCurrentSong ? "bg-gradient-to-r from-[#14b8a6]/10 to-transparent" : "bg-transparent"
          ...
          <Link to={`/songs/${song.key}`}>
            <Tooltip text={song?.title}>
              <p className={`text-base font-bold truncate transition-all ${
                isCurrentSong ? 'text-[#2dd4bf]' : 'text-white group-hover:text-[#2dd4bf]'
              }`}>{displayTitle}</p>
            </Tooltip>
          </Link>
        ...
        <Link to={`/songs/${song.key}`}>
          <Tooltip text={song?.title}>
            <p className={`font-medium text-sm truncate transition-colors ${
              isCurrentSong ? 'text-[#2dd4bf]' : 'text-white hover:text-[#2dd4bf]'
            }`}>
              {displayTitle}
            </p>
          </Tooltip>
    ...
    >
      ...
      <div className="w-full flex flex-col bg-gradient-to-br from-white/[0.02] to-transparent rounded-xl p-4 backdrop-blur-sm border border-white/5 hover:border-white/10 transition-all duration-300">
        <div className="flex flex-row justify-between items-center mb-4">
          <h2 className="text-white font-bold text-xl bg-gradient-to-r from-white to-[#2dd4bf] bg-clip-text text-transparent">Top Tracks</h2>
          <Link to="/top-charts">
            <p className="text-gray-300 text-sm cursor-pointer hover:text-[#2dd4bf] transition-all duration-300 hover:translate-x-1">See more →</p>
          </Link>
        </div>
      ...
      <div className="w-full flex flex-col mt-6 bg-gradient-to-br from-white/[0.02] to-transparent rounded-xl p-4 backdrop-blur-sm border border-white/5 hover:border-white/10 transition-all duration-300">
        <div className="flex flex-row justify-between items-center mb-4">
          <h2 className="text-white font-bold text-xl bg-gradient-to-r from-white to-[#5eead4] bg-clip-text text-transparent">Recently Played</h2>
        </div>
