  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed top-[70px] right-[450px] xl:right-[500px] z-40 bg-white/10 hover:bg-white/20 text-white p-2 rounded-full transition-all duration-200 backdrop-blur-sm"
