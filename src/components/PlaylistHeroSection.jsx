...
const PlaylistHeroSection = ({ stats, onCreatePlaylist }) => {
  ...
  return (
    <div className="bg-gradient-to-r from-[#14b8a6]/10 via-purple-600/10 to-[#14b8a6]/10 rounded-xl sm:rounded-2xl p-3 sm:p-4 lg:p-6 border border-white/10">
      <div className="flex flex-col items-center gap-3 lg:gap-4">
        {/* Title  */}
        <h2 className="text-base sm:text-lg lg:text-xl font-bold text-white text-center">Your Music Collection</h2>

        {/* Stats Grid */}
        <div className="grid grid-cols-3 gap-2 sm:gap-3 lg:gap-4 w-full max-w-2xl mx-auto">
          {/* Playlists Count */}
          <div className="bg-white/5 backdrop-blur-sm rounded-lg lg:rounded-xl p-3 sm:p-4 lg:p-5 border border-white/10">
            <div className="flex flex-col items-center justify-center text-center h-full">
              ...
              <p className="text-xl sm:text-2xl lg:text-2xl xl:text-3xl font-bold text-white">{stats.playlistCount}</p>
            </div>
          </div>
          ...
          <div className="bg-white/5 backdrop-blur-sm rounded-lg lg:rounded-xl p-3 sm:p-4 lg:p-5 border border-white/10">
            <div className="flex flex-col items-center justify-center text-center h-full">
              ...
              <p className="text-xl sm:text-2xl lg:text-2xl xl:text-3xl font-bold text-white">{stats.totalTracks}</p>
            </div>
          </div>
          ...
          <div className="bg-white/5 backdrop-blur-sm rounded-lg lg:rounded-xl p-3 sm:p-4 lg:p-5 border border-white/10">
            <div className="flex flex-col items-center justify-center text-center h-full">
              ...
              <p className="text-xl sm:text-2xl lg:text-2xl xl:text-3xl font-bold text-white whitespace-nowrap">
        ...
        <button
          ...
          className="group relative flex items-center gap-2 bg-gradient-to-r from-[#14b8a6] to-[#0d9488] hover:from-[#0d9488] hover:to-[#14b8a6] text-white font-semibold py-2 sm:py-2.5 px-5 sm:px-6 rounded-full transition-all transform hover:scale-105 shadow-xl shadow-[#14b8a6]/30 justify-center text-sm sm:text-base"
        >
