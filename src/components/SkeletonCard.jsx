...
const SongCard = ({ song, isPlaying, activeSong, data, i }) => {
  ...
  return (
    ...
    >
      ...
      {isCurrentSong && (
        <div className="absolute top-3 left-3 z-10 bg-white rounded-full px-3 py-1.5 shadow-lg flex items-center gap-2">
          <div className="flex gap-0.5">
            <div className="w-0.5 h-3 bg-gray-900 rounded-full animate-[pulse_1s_ease-in-out_infinite]" />
            <div className="w-0.5 h-3 bg-gray-900 rounded-full animate-[pulse_1s_ease-in-out_infinite_0.2s]" />
            <div className="w-0.5 h-3 bg-gray-900 rounded-full animate-[pulse_1s_ease-in-out_infinite_0.4s]" />
          </div>
